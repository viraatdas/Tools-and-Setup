...
# use delete not rm
alias rm="echo 'use delete instead'"

# rsync script for CS 490 LDA
function rsync_script() {
    LOCAL_DIR="/Users/viraatdas/Documents/GitHub/Purdue-Fall-2020/CS_490_LDA/HW/HW4"
    REMOTE_DIR="/home/dasv/490_LDA/HW/HW4"
    #REMOTE_DIR="/homes/dasv/scratch/CS_490_LDA/HW/HW4"
    HOST="dasv@data.cs.purdue.edu"
    alias run_rsync='rsync -azP --exclude ".*/" --exclude ".*" --exclude "tmp/" $LOCAL_DIR $HOST:$REMOTE_DIR'
    run_rsync; fswatch -or $LOCAL_DIR | while read f; do run_rsync; done
}
...
# pyenv
export PATH="/Users/viraatdas/.pyenv/bin:$PATH"                
eval "$(pyenv init -)"
